...
/****** Object:  Database [PersonDB]    Script Date: 4/05/2024 2:15:00 p. m. ******/
CREATE DATABASE [PersonDB]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'PersonDB', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\PersonDB.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'PersonDB_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\PersonDB_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [PersonDB] SET AUTO_CLOSE ON 
GO
...
ALTER DATABASE [PersonDB] SET READ_COMMITTED_SNAPSHOT ON 
GO

ALTER DATABASE [PersonDB] SET HONOR_BROKER_PRIORITY OFF 
GO

ALTER DATABASE [PersonDB] SET RECOVERY SIMPLE 
GO
